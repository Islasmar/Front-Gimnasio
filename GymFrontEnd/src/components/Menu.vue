            ...
            <li>
               <button type="button"
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg"
                     ...
                     aria-hidden="true" viewBox="0 0 448 512">
                     <path
               ...
               <ul id="dropdown-example5" class="hidden py-2 space-y-2">
                  <li>
                     <RouterLink to="/dietas">
                        <a href="#"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Dietas
                           Admin</a>
                     </RouterLink>
                  </li>
                  <li>
               ...
               <ul id="dropdown-example2" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <RouterLink to="/Opiniones_clientes_Admin">
                        <a href="#"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Opiniones
                           De clientes</a>
                     </RouterLink>
                  </li>
                  <li>
                  ...
                  <li>
                     <RouterLink to="/PreguntasAdmin">
                        <a href="#"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Preguntas</a>
                     </RouterLink>
                  </li>
                  <li>
                  ...
                  <li>
                     <RouterLink to="/EvaluacionServicioAdmin">
                        <a href="#"
                           class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Evaluaciones
                           de Servicios</a>
                     </RouterLink>
                  </li>
                  <li>
